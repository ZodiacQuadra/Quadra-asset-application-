...
import { bulkUploadAttendance } from "../../Services/AdminAttendanceReportService";
...
const AttendanceBulkUploadDialog = (props: PropTypes) => {
    const { shifts } = useConfigurations();
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        try {
            await bulkUploadAttendance(startDate, endDate, shiftId, file!);
            dispatchToast(
                <Toast>
    ...
    const downloadSample = () => {
        const ws = XLSX.utils.aoa_to_sheet([
            ["Email", "LeaveDates"],
            ["john@example.com", "06/01/2026, 08/01/2026"],
        ]);
                ...
                <DialogSurface className={styles.surface}>
                    <div style={{ display: "flex", flexDirection: "column" }}>
                        ...
                        <div className={styles.header}>
                            <div>
                                <div className={styles.titleText}>Bulk Upload Attendance</div>
                                <div className={styles.subText}>
                                    Upload an Excel file with attendance records for a date range.
                                </div>
                            </div>
                            <button
                                onClick={handleClose}
...
export default AttendanceBulkUploadDialog;
